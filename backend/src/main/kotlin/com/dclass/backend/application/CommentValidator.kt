...
class CommentValidator(
    ...
    fun validateCreateComment(userId: Long, postId: Long): CommentValidatorDto {
    ...
    private fun validateCommon(userId: Long, postId: Long): CommentValidatorDto {
        ...
        return CommentValidatorDto(post, community.title)
    }
}