...
class DatabaseInitializer(
    ...
    private fun populateDepartment() {
        val departments = listOf(
            ...
            Department(title = "금형설계학과"),
            Department(title = "기계공학과"),
            Department(title = "나노공학과"),
            Department(title = "도시공학과"),
            Department(title = "로봇공학과"),
            Department(title = "무인항공학과"),
            Department(title = "반도체학과"),
            Department(title = "섬유학과"),
            Department(title = "세라믹공학과"),
            Department(title = "소방방재학과"),
            Department(title = "신소재공학과"),
            Department(title = "신재생에너지공학과"),
            Department(title = "안전공학과"),
            Department(title = "원자력공학과"),
            Department(title = "자동차공학과"),
            Department(title = "전기전자공학과"),
            Department(title = "철도교통학과"),
            Department(title = "토목공학과"),
            Department(title = "항공우주공학과"),
            Department(title = "화학공학과"),
            Department(title = "생명과학과"),
            Department(title = "원예학과"),
            Department(title = "조경학과"),
            Department(title = "동물학과"),
            Department(title = "약학공학과"),
            Department(title = "식품과학과"),
            ...
            Department(title = "산림공학과"),
            Department(title = "지질학과"),
            Department(title = "지리학과"),
            Department(title = "의학보건계열"),
            Department(title = "의예과"),
            Department(title = "간호학과"),
            Department(title = "약학과"),
            Department(title = "치의학과"),
            Department(title = "물리치료학과"),
            Department(title = "한의학과"),
            Department(title = "환경보건학과"),
            Department(title = "긴급구조학과"),
            Department(title = "보건행정학과"),
            Department(title = "임상병리학과"),
            Department(title = "방사선학과"),
            Department(title = "미술치료학과"),
            Department(title = "언어재활학과"),
            Department(title = "응용미술학과"),
            Department(title = "조소과"),
            Department(title = "회화과"),
            Department(title = "연극영화학과"),
            Department(title = "그래픽디자인학과"),
            Department(title = "영상디자인학과"),
            Department(title = "산업디자인학과"),
            Department(title = "공업디자인학과"),
            Department(title = "공간디자인학과"),
            Department(title = "시각디자인학과"),
            Department(title = "금속공예학과"),
            Department(title = "애니메이션학과"),
            Department(title = "실용음악학과"),
            Department(title = "성악학과"),
            Department(title = "응용음악학과"),
            Department(title = "패션디자인학과"),
            Department(title = "실내디자인학과"),
            Department(title = "광고디자인학과"),
            Department(title = "무용스포츠학과"),
            Department(title = "사회체육학과"),
            Department(title = "건강관리학과"),
