...
class RecruitmentReply extends ConsumerStatefulWidget {
  final RecruitmentReplyModel reply;
  final bool selectReply;
  final bool isMine;
  final int myId;
  final bool isWriter;

  const RecruitmentReply({
    super.key,
    required this.reply,
  ...
  @override
  ConsumerState<RecruitmentReply> createState() => _RecruitmentReply();
}

class _RecruitmentReply extends ConsumerState<RecruitmentReply> {
  @override
  void initState() {
    super.initState();
  }
