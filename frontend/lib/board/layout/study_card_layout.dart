...
import 'package:frontend/board/component/text_with_icon_for_view.dart';
...
class StudyCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _StudyCard();
}

class _StudyCard extends ConsumerState<StudyCard> {
  @override
  void initState() {
    super.initState();
  }
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                _renderCategoryCircleUi(categoryCodesReverseList2[
                        widget.recruitmentResponseModel.type] ??
                    widget.recruitmentResponseModel.type),
                Row(
                  children: [
                    TextWithIconForView(
                      ...
                      iconSize: 15,
                      text: widget.recruitmentResponseModel.commentReplyCount
                          .toString(),
                    ),
                    const SizedBox(
                      width: 13,
                    ...
                    TextWithIconForView(
                      ...
                      iconSize: 18,
                      text:
                          widget.recruitmentResponseModel.scrapCount.toString(),
                    ...
                    Container(
                      ...
                      child: widget.recruitmentResponseModel.limit != -1
                          ? Row(
                              ...
                              children: [
                                Text(
                                  widget.recruitmentResponseModel.limit
                                      .toString(),
            ...
            Column(
              ...
              children: [
                Text(
                  _formatText(widget.recruitmentResponseModel.title, 40),
                  style: const TextStyle(
                    fontSize: 12.0,
                    fontWeight: FontWeight.w500,
                  ),
                ...
                Text(
                  _formatText(widget.recruitmentResponseModel.content, 80),
                  softWrap: true,
                  style: const TextStyle(
                    fontSize: 10,
