...
final myScrapStateNotifierProvider =
StateNotifierProvider<MyScrapStateNotifier, CursorPaginationModelBase>(
        (ref) {
...
class MyScrapStateNotifier extends StateNotifier<CursorPaginationModelBase> {
  bool _mounted = true;
  ...
  Future<void> paginate({
    ...
    try {
      ...
      final resp = await repository.getScrappedPosts(lastId, size);
